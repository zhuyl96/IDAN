...
class IDANModel(GlobalAttention):
    ...
    def model(self, args):
        ...
        sentiment_att = MultiHeadAttention(head_num=self.n_heads,
                                           kernel_regularizer=l2(l=self.l2_reg),
                                           bias_regularizer=l2(l=self.l2_reg),
                                           name='Sentiment_MultiAtt')([sentiment_lstm, sentiment_lstm, sentiment_lstm])
        ...
        model = Model(inputs=[sentence_input, sentiment_input], outputs=output, name='IDAN roberta')

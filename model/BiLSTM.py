...
class BiLSTM:
    def __init__(self, args, hidden_size=256, dropout=0.1, loss='categorical_crossentropy', ):
        """
        :param args:
    ...
    def model(self, args):
        ...
        dropout = Dropout(rate=self.dropout, name='Dropout')(bilstm)
        ...
        model = Model(inputs=input, outputs=output, name='BiLSTM')
